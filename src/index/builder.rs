use crate::{
    analysis::tokenizer::analyze,
    index::{postings, store},
};
use std::io::BufRead;
...
mod tests {
    ...
    fn test_build_indexes_terms() {
        ...
        let index: postings::Index =
            serde_json::from_str(&std::fs::read_to_string(&index_out).unwrap()).unwrap();
